...
stdenv.mkDerivation {
  ...
  # NOTE: we install only headers that are really needed to keep
  # closure size reasonable.
  installPhase = ''
    mkdir -p $out/include
    sdk=PrivateSDK10.10.sparse.sdk
    sdk9=PrivateSDK10.9.sparse.sdk
    cp $sdk9/usr/local/include/sandbox_private.h $out/include/sandbox_private.h
    ...
    cp -RL $sdk/System/Library/Frameworks/CoreFoundation.framework/Headers $out/include/CoreFoundationPrivateHeaders
  '';
}
